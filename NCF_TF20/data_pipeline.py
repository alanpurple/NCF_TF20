...
class BaseDataConstructor(threading.Thread):
  ...
  def _construct_training_epoch(self):
    ...
    tf.compat.v1.logging.info("Epoch construction complete. Time: {:.1f} seconds".format(
  ...
  def _construct_eval_epoch(self):
    ...
    tf.compat.v1.logging.info("Eval construction complete. Time: {:.1f} seconds".format(
        timeit.default_timer() - start_time))
...
class MaterializedDataConstructor(BaseDataConstructor):
  ...
  def construct_lookup_variables(self):
    ...
    tf.compat.v1.logging.info("Negative sample table built. Time: {:.1f} seconds".format(
        timeit.default_timer() - start_time))
...
class BisectionDataConstructor(BaseDataConstructor):
  ...
  def construct_lookup_variables(self):
    ...
    tf.compat.v1.logging.info("Negative total vector built. Time: {:.1f} seconds".format(
        timeit.default_timer() - start_time))
